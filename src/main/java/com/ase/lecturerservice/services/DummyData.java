...
public class DummyData {
  ...
  public static List<Exam> EXAMS = List.of(
      ...
      Exam.builder()
          ...
          .totalPoints(MockValues.IntMocks.TOTAL_POINTS.getValue())
          .examType(ExamType.ANDERES)
          .date(date)
          .time(MockValues.IntMocks.TIME_SECONDS.getValue())
          .allowedResources(List.of("Laptop", "IDE"))
          .attempt(MockValues.IntMocks.ATTEMPT.getValue())
          .etcs(MockValues.IntMocks.ETCS.getValue())
      ...
      Exam.builder()
          ...
          .totalPoints(MockValues.IntMocks.TOTAL_POINTS.getValue())
          .examType(ExamType.MUENDLICH)
          .date(LocalDate.of(
              MockValues.IntMocks.DATE_YEAR.getValue(),
              MockValues.IntMocks.DATE_MONTH.getValue(),
              MockValues.IntMocks.DATE_DAY2.getValue()
          ))
          .time(MockValues.IntMocks.TIME_SECONDS.getValue())
          .allowedResources(List.of("Lab Equipment", "Safety Manual"))
          .attempt(MockValues.IntMocks.ATTEMPT.getValue())
          .etcs(MockValues.IntMocks.ETCS.getValue())
          .room("Online Submission")
          .lecturerUuid(MockValues.UuidMocks.LECTURER_UUID.getValue())
      ...
      Exam.builder()
          ...
          .date(date)
          .time(MockValues.IntMocks.TIME_SECONDS.getValue())
          .allowedResources(List.of("Notes", "Textbook"))
          .attempt(MockValues.IntMocks.ATTEMPT.getValue())
          .etcs(MockValues.IntMocks.ETCS.getValue())
          .room("Room C303")
          .lecturerUuid(MockValues.UuidMocks.LECTURER_UUID.getValue())
      ...
      Exam.builder()
          ...
          .build(),
      Exam.builder()
          .uuid(MockValues.UuidMocks.EXAM_UUID7.getValue())
          .name("Project 1")
          .totalPoints(MockValues.IntMocks.TOTAL_POINTS.getValue())
          .examType(ExamType.PRAESENTATION)
          .date(date)
          ...
          .build(),
      Exam.builder()
          .uuid(MockValues.UuidMocks.EXAM_UUID8.getValue())
          .name("Project 2")
          .totalPoints(MockValues.IntMocks.TOTAL_POINTS.getValue())
          .examType(ExamType.PRAESENTATION)
